module.exports = {
    ...
    ERROR_CATEGORY: 'Chuyên mục phải được chọn!',
    ERROR_STATUS: 'Trạng thái phải được chọn!',
    ERROR_POSITION: 'Chức vụ phải được chọn!',
    ERROR_TYPE: 'Loại bài viết phải được chọn!',
    ...
    /*
    ERROR_LOGIN_USERNAME_NOTEXIST: 'Không tồn tại user!',
    ERROR_LOGIN_PASSWORD_INCORRECT: 'Mật khẩu không đúng!',
    */
}